...
namespace EImece.Domain.Services
{
    public class ShoppingCartService : BaseEntityService<ShoppingCart>, IShoppingCartService
    {
        ...
        {
            buyNowSession.Customer.UserId = UserType.BuyNowCustomer;
            ...
            Order savedOrder = SaveOrder(""+buyNowSession.Customer.Id, buyNowSession, checkoutForm, shippingAddressId, shippingAddressId);
            SaveOrderProduct(shoppingCart, savedOrder);
        }
