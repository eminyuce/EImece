...
namespace EImece.Domain.Services
{
    public class IyzicoService
    {
        ...
        public CheckoutFormInitialize CreateCheckoutFormInitializeBuyNow(BuyNowModel buyNowModel)
        {
            ...
            firstBasketItem.Price = decimal.Round(item.Product.Price, 2, MidpointRounding.AwayFromZero).ToString().Replace(",", "."); // item.Price.ToString("0.0", CultureInfo.GetCultureInfo(Constants.EN_US_CULTURE_INFO));
