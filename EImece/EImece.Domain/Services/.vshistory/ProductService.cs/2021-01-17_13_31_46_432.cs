...
namespace EImece.Domain.Services
{
    public class ProductService : BaseContentService<Product>, IProductService
    {
        ...
        public ProductDetailViewModel GetProductDetailViewModelById(int id)
        {
            ...
            if (result.RelatedProducts.IsEmpty())
            {
                result.RelatedProducts = ProductRepository.GetRandomProductsByCategoryId(product.ProductCategory.ParentId, relatedProductTake, product.Lang, id)
            }
