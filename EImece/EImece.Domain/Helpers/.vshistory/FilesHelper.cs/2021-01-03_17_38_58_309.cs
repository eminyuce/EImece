...
namespace EImece.Domain.Helpers
{
    public class FilesHelper
    {
        ...
        public Tuple<string, string> GetImageSrcPath(int fileStorageId)
        {
            ...
            var fullPath = HttpContext.Current.Server.MapPath("~/media/images/" + fileStorage.FileName);
            var candidatePathThb = HttpContext.Current.Server.MapPath("~/media/images/thumbs" + fileStorage.FileName);
