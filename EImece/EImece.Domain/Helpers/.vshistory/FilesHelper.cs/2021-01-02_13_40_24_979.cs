...
namespace EImece.Domain.Helpers
{
    public class FilesHelper
    {
        ...
        public SavedImage GetResizedImage(int fileStorageId, int width, int height)
        {
            ...
            byte[] imageBytes = GetFileStorageFromCache(fileStorageId, fileStorage);
        ...
        private void GetFileStorageFromCache(int fileStorageId, out FileStorage fileStorage, out byte[] imageBytes)
        {
