...
namespace EImece.Domain.Helpers
{
    public class FilesHelper
    {
        ...
        public Tuple<string, string> GetImageSrcPath(int fileStorageId)
        {
            ...
            var fileNames = GetFileNames(fileStorage.FileName);
            var fullPath = HttpContext.Current.Server.MapPath(fileNames.Item1);
            var candidatePathThb = HttpContext.Current.Server.MapPath(fileNames.Item2);
