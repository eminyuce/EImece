...
namespace EImece.Domain.Helpers.EmailHelper
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        public void SendOrderConfirmationEmail(EmailAccount emailAccount,  OrderConfirmationEmailRazorTemplate razorTemplate)
        {
            var customer = razorTemplate.FinishedOrder.Customer;
            var fromAddress = emailAccount.Email;
            if (string.IsNullOrEmpty(fromAddress))
            {
                throw new ArgumentException("From Address cannot be null");
