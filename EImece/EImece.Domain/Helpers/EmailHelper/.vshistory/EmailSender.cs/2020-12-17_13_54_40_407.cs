...
namespace EImece.Domain.Helpers.EmailHelper
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        public void SendOrderConfirmationEmail(EmailAccount emailAccount, Customer customer, Tuple<string, string> renderedEmailTemplate)
        {
            ...
            if (renderedEmailTemplate == null || string.IsNullOrEmpty(renderedEmailTemplate.Item1)  && string.IsNullOrEmpty(renderedEmailTemplate.Item2 ))
            {
