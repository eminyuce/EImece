...
namespace EImece.Domain.Helpers
{
    public class StringCipher
    {
        ...
        public static string EncryptEscape(string text)
        {
            ...
            // return HttpUtility.UrlEncode(Encrypt(text, PassWord));
            // return EncryptQueryString(text, PassWord, "test");
        }
        ...
        public static string DecryptEscape(string cipherText)
        {
            ...
            try
            {
                cipherText = Base64UrlEncoder.Decode(cipherText);
                ret = Decrypt(cipherText, PassWord);
            }
            catch (Exception e)
            {
                ret = e.Message;
