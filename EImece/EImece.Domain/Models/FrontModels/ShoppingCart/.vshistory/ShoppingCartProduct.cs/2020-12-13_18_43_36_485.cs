...
namespace EImece.Domain.Models.FrontModels.ShoppingCart
{
    ...
    public class ShoppingCartProduct
    {
        ...
        public ShoppingCartProduct(Product product, List<ProductSpecItem> ProductSpecItems)
        {
            ...
            if (this.ProductSpecItems == null)
            {
                this.ProductSpecItems = new List<ProductSpecItem>();
            }
