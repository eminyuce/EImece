        ...
        public void Add(ShoppingCartItem item)
        {
            if (ShoppingCartItems.Any(r => r.Product.Id == item.Product.Id))
            {
                ...
                if (item.Product.ProductSpecItems.IsNotEmpty())
                {
                    ...
                    {
                        if (existingItem.Product.ProductSpecItems.Any(r => r.SpecsValue.Equals(ProductSpecItem.SpecsValue, StringComparison.InvariantCultureIgnoreCase)))
                        {
                            var existingItemSpecs = existingItem.Product.ProductSpecItems.FirstOrDefault(r => r.SpecsValue.Equals(ProductSpecItem.SpecsValue, StringComparison.InvariantCultureIgnoreCase));
