        ...
        public decimal PriceWithDiscount
        {
            get
            {
                if (HasDiscount)
                {
                    ...
                    decimal categoryDiscount = productCategory.DiscountPercantage.HasValue ? (decimal)ProductCategory.DiscountPercantage.Value / 100 : 0;
                    return Price - (Discount) - (Price * (categoryDiscount));
                }
                else
                {
                    return Price;
