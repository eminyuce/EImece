        ...
        public string CreateChildDataContent
        {
            get
            {
                var productImgLink = MainImage.GetCroppedImageUrl(
                 this.MainImageId,
                 300, 0, false);
                var result = string.Format("<img src='{0}' class='d-block mt-n1' alt='{1}'><div class='text-center font-size-sm font-weight-semibold mt-n0 pb-0'>{2}</div>", this.ProductCategoryLink,
                    this.Name,
                    this.Name);
