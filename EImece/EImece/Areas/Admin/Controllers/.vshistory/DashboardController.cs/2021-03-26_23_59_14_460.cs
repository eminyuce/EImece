...
namespace EImece.Areas.Admin.Controllers
{
    public class DashboardController : BaseAdminController
    {
        ...
        public PartialViewResult Languages()
        {
            ...
            var cultureCookie = Request.Cookies[Domain.Constants.AdminCultureCookieName];
            string selected = cultureCookie == null ? "" : cultureCookie.Values[Domain.Constants.ELanguage];
            ViewBag.cultureCookie = selected;
