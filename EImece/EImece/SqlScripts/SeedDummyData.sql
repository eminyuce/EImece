...
;WITH RequiredSettings AS (
    SELECT * FROM (VALUES
        -- Description=SystemSettings for keys bound by SystemSettingModel (GetSystemSettingModel filters on it).
        ...
        (N'SystemUsers_help/info_section', N'<p>Bu sayfada sistem kullanıcılarını yönetirsiniz.</p><ul><li>Ad, soyad, e-posta veya kullanıcı adına göre arama yapabilirsiniz.</li><li>Rol (<strong>Yönetici</strong> / <strong>Kullanıcı</strong>) ve duruma göre filtreleme yapabilirsiniz.</li><li><strong>Yeni kullanıcı tanımla</strong> butonu ile sisteme kullanıcı ekleyebilirsiniz.</li><li>İşlemler menüsünden düzenleyebilir, şifre sıfırlayabilir veya hesabı askıya alabilirsiniz.</li></ul>', N'SystemSettings'),
        (N'ProductPage_help/info_section', N'<p>Bu sayfada <strong>ürün</strong> oluşturur veya düzenlersiniz.</p><ul><li>Soldaki ağaçtan ürünün <strong>kategorisini</strong> seçin (zorunlu).</li><li><strong>Fiyat</strong>: Satış fiyatı. <strong>Ürün indirimi</strong> varsa fiyat üzerinden ek indirim uygulanır.</li><li><strong>Ana sayfa</strong>: Ürünü ana sayfada gösterir. <strong>Kampanya</strong>: Kampanya listelerinde öne çıkarır.</li><li><strong>Marka / etiketler</strong>: Filtreleme ve vitrin için kullanılır.</li><li><strong>Ürün Ölçü / Renk Seçenekleri</strong>: Mağaza ürün detayında beden ve renk açılır listeleri için virgülle ayırın (ör. <code>S,M,L,XL</code>).</li><li>Kategori şablonuna bağlı ek özellikler ürün listesinden “özellik” ikonuyla doldurulur.</li></ul>', N'SystemSettings')
