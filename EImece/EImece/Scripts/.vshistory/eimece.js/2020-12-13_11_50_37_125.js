...
$("#AddToCart").click(function () {
    ...
    $('[data-product-selected-specs' + productId + ']').each(function () {
        var selectedSpecsName = $(this).attr('name');
        var selectedSpecsvalue = $(this).val();
        console.log("selectedSpecsName:" + selectedSpecsName + "  selectedSpecsvalue:"+selectedSpecsvalue);
    });
