...
activeModalForFirstPage();
function activeModalForFirstPage() {
...
function hidePanel() {
    $('#exampleModalLong').removeClass("modal fade show");
    $('#exampleModalLong').addClass("modal fade");
    $("#exampleModalLong").attr("aria-hidden", "true");
    $("#exampleModalLong").attr("style", "display:none;");
}
function showPanel() {
    $('#exampleModalLong').removeClass("modal fade");
    $('#exampleModalLong').addClass("modal fade show");
    $("#exampleModalLong").attr("style", "display: block; padding-right: 17px;");
    $("#exampleModalLong").attr("aria-modal", "true");
}