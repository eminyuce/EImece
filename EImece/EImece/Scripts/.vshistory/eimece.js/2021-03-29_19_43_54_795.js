...
function activeModalForFirstPage() {
    ...
    if (queryString === "?lang=tr-TR" || queryString === "?lang=en-US" || queryString === "") {
        showPanel();
    } else {
        hidePanel();
    }
...
function hidePanel() {
    $('#covidModal').css('width', '0px');
    $('#covidModal').css('height', '0px');
...
function showPanel() {
    ...
    if (/Mobi/.test(navigator.userAgent)) {
        // mobile!
        $('#covidModal').css('width', '350px');
        $('#covidModal').css('height', '605px');
    } else {
        $('#covidModal').css('width', '562px');
        $('#covidModal').css('height', '605px');
    }
}