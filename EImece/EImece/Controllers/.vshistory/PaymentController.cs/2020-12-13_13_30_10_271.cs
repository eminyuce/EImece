...
namespace EImece.Controllers
{
    public class PaymentController : BaseController
    {
        ...
        public ActionResult AddToCart(int productId, int quantity, string orderGuid, ProductSpecItem [] productSpecItems)
        {
            ...
            {
                var ooo = JsonConvert.DeserializeObject<List<ProductSpecItem>>(productSpecItems);
                item.ProductSpecItems.AddRange(productSpecItems.ToList());
            }
            ...
            PaymentLogger.Info(JsonConvert.SerializeObject(shoppingCart)+"  "+ productSpecItems);
