...
namespace EImece.Controllers
{
    public class PaymentController : BaseController
    {
        ...
        public ActionResult AddToCart(int productId, int quantity, string orderGuid, List<ProductSpecItem> selectedSpecs)
        {
            ...
            {
                item.ProductSpecItems.AddRange(selectedSpecs.ToList());
            }
