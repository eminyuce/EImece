    ...
    public class PaymentController : BaseController
    {
       ...
       // [Route(Domain.Constants.ShoppingCartPrefix)]
        ...
        public ActionResult CheckoutBillingDetails(Customer customer)
        {
            ...
            {
                ModelState.AddModelError("ProductCategoryId", Resource.ProductCategoryIdErrorMessage);
                ModelState.AddModelError("", Resource.CheckoutBillingDetailsErrorMessageNotValidCustomer);
