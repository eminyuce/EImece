...
namespace EImece.Controllers
{
    ...
    public class ProductsController : BasePaymentController
    {
        ...
        public ActionResult BuyNow(String productId, Customer customer)
        {
            ...
            buyNowModel.ProductId = productId.GetId();  
            buyNowModel.Customer = customer;
            BuyNowSession.ShippingAddress = SetAddress(customer, shoppingCart.ShippingAddress);
            BuyNowSession = buyNowModel;

            buyNowModel.Product = ProductService.GetProductDetailViewModelById(buyNowModel.ProductId);
            IyzicoService.CreateCheckoutFormInitializeBuyNow(buyNowModel);
