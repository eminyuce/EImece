...
namespace EImece.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult SocialMediaLinks()
        {
            ...
            resultList.Add(Constants.YotubeWebSiteLink, string.Format("https://twitter.com/intent/tweet?url={0}&text={1}", Url.Encode(SettingService.GetSettingByKey(Constants.YotubeWebSiteLink)), Url.Encode(text)));
