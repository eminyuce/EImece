...
namespace EImece.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult DisplayAllCache()
        {
            ...
            List<string> cacheKeys2  = System.Web.HttpRuntime.Cache.GetEnumerator().Select(kvp => kvp.Key).ToList();
           
            return View(new AllCacheList({ httpRuntimeKey= cacheKeys2,memoryCacheKey= cacheKeys }));
        }
