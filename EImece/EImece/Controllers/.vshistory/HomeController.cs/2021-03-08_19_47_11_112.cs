...
namespace EImece.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult saveAddress()
        {
            ...
            billingAddress.Name = Resource.ShippingAddress;
            billingAddress.AddressType = (int)AddressType.ShippingAddress;
            billingAddress.Description = "Altayçeşme Öz Sok. No:4/40 Maltepe 12345  İstanbul Türkiye";
            billingAddress.City = "istanbul";
            billingAddress.Country = "turkiye";
            var billingAddress1 = AddressService.SaveOrEditEntity(billingAddress);
