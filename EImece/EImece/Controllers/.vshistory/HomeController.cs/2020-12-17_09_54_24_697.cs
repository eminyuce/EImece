...
namespace EImece.Controllers
{
    public class HomeController : BaseController
    {
        ...
        {
            var cOrder = OrderService.GetOrderById(1);
            Customer customer = CustomerService.GetUserId("44a72377-7a04-49ec-b8bb-40b9140deddc");

          
            var pp = new OrderConfirmationEmailRazorTemplate();
            pp.CompanyAddress = "3828 Mall Road  Los Angeles, California, 90017";
            pp.CompanyEmailAddress =  SettingService.GetSettingObjectByKey(Constants.WebSiteCompanyEmailAddress);
            pp.CompanyPhoneNumber = SettingService.GetSettingObjectByKey(Constants.WebSiteCompanyPhoneAndLocation);
            pp.Customer = cOrder.Customer;
